...
void limit(){
	...
	std::vector<TFile*> fs;
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH3000.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH4000.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH5000.root"));	
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH6000.root"));
