...
#include "TFile.h"
#include "TTree.h"
#include "/home/nadjieh/work/Haamumu/interface/HambFitter.h"
#include "/home/nadjieh/work/Haamumu/interface/RDS.h"
#include "/home/nadjieh/work/Haamumu/interface/RDSData.h"
#include "/home/nadjieh/work/Haamumu/interface/RDSRegion.h"
#include "/home/nadjieh/work/Haamumu/interface/CutApplierRDS.h"
#include "TString.h"
#include "TCanvas.h"
#include "TH1.h"
#include "TH2.h"
    ...
    for (unsigned int i = 0; i < rds.size(); i++) {
        ...
        for (int eventNumber = 0; eventNumber < rds[i]->fChain->GetEntriesFast(); eventNumber++) {
            ...
            if(rds[i]->jetmetbjet1CSVdisc > 0.898)
                nb++;
            if(rds[i]->jetmetbjet2CSVdisc > 0.898)
                nb++;
            if(!(nb > 0))
                continue;

            if (!isSelected2(rds[i], cutVals))
                continue;
