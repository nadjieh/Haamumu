...
test()
{
  ...
  RooAddPdf bkg(name+"_bkg", "all bkgs",topPdf, expo, frac);  
  ...
  RooAddPdf sum(name + "_sum", "Gaussian crystal ball and exponential PDF", RooArgList(bwxCryBall, bkg), RooArgList(s_bw, b));
  ...
  fracInt = bkg.createIntegral(eventSelectionamassMu, eventSelectionamassMu, "SU");
...
/*
| | SL | SM | SU |
|bkg | 463.827 \pm 37.0446|121.613 \pm 9.71291|33.8186 \pm 2.701|
|B.W | 86.3707 \pm 2.40482|177.092 \pm 4.93077|2218.33 \pm 61.7651|
|Sum fit | 550.198 \pm 37.1226|298.705 \pm 10.8928|2252.15 \pm 61.8241|
|MC Data | 547.086 | 383.416 | 2255.25 |
*/
