...
void F_test_commented (int Nbins=20, int Ndata=5000, double alpha=0.1, int option=1) {
  ...
  double xmax = 3.;
  TH1D * Data0 = new TH1D ("Data0", "", Nbins, 0., xmax);
  TH1D * Data1 = new TH1D ("Data1", "", Nbins, 0., xmax);
  TH1D * Data2 = new TH1D ("Data2", "", Nbins, 0., xmax);
  TH1D * Data3 = new TH1D ("Data3", "", Nbins, 0., xmax);
  ...
  TF1 * Pol0 = new TF1 ("Pol0","[0]", 0., xmax);
  TF1 * Pol1 = new TF1 ("Pol1","[0]+[1]*x", 0., xmax);
  TF1 * Pol2 = new TF1 ("Pol2","[0]+[1]*x+[2]*x*x", 0., xmax);
  TF1 * Pol3 = new TF1 ("Pol3","[0]+[1]*x+[2]*x*x+[3]*x*x*x", 0., xmax);
