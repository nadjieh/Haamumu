...
void limit(){
	...
	std::vector<TFile*> fs;
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH305.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH405.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH505.root"));	
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH605.root"));
