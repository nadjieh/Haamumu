...
TString name = "test";
  ...
  /*TFile* f = new TFile("DoubleMu2012_Summer12_final_10.root", "READ");
 ...
 //////////// FIT IN SIGNAL REGION, SM /////////
  ...
  TFile* ftop = new TFile("TTFullLept_Summer12_final_10.root", "READ");
