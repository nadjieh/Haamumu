...
void mytest(int seed = 37) {
    ...
    stringstream lambda; lambda << -0.248848;
    stringstream alpha; alpha << 1.26978;
    stringstream n; n <<  1.21274;
    stringstream meanbw; meanbw <<  90.6073;
    stringstream sigmabw; sigmabw <<  1.06257;
    stringstream meancb; meancb <<  0.562947;
    stringstream sigmacb; sigmacb <<  1.75678;
    ///////////////////////////////////
