...
void mytest(int seed = 37) {
	...
	stringstream lambda; lambda << -0.149181;
	stringstream alpha; alpha << 3.38875;
	stringstream n; n <<  0.775103;
	stringstream meanbw; meanbw <<  90.105;
	stringstream sigmabw; sigmabw <<  1;
	stringstream meancb; meancb <<  2.52809;
	stringstream sigmacb; sigmacb <<  0.0499333;
    ///////////////////////////////
