...
void limit(){
	...
	std::vector<TFile*> fs;
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH3030.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH4040.root"));
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH5050.root"));	
	fs.push_back( TFile::Open("higgsCombineTest.Asymptotic.mH6060.root"));
