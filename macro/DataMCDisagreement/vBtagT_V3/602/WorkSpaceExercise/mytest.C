...
void mytest(int seed = 37) {
    ...
    stringstream lambda; lambda << -0.19061;
    stringstream alpha; alpha << 0.576923;
    stringstream n; n <<  0.92271;
    stringstream meanbw; meanbw <<  88.1101;
    stringstream sigmabw; sigmabw <<  1.19309;
    stringstream meancb; meancb <<  4.86985;
    stringstream sigmacb; sigmacb <<  4.28267e-06;
    ///////////////////////////////
