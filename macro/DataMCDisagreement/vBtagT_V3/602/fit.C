...
fit()
{
  ...
  /*TFile* f = new TFile("mcMass602.root", "READ");
  ...
  TFile* f = new TFile("DoubleMu2012_Summer12_final_12.root", "READ");
 ...
 //////////// FIT IN SIGNAL REGION, SM /////////
  ...
  TFile* ftop = new TFile("TTFullLept_Summer12_final_12.root", "READ");
