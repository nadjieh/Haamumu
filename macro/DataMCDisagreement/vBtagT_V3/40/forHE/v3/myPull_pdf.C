...
//========= by ROOT version5.34/19
   ...
   pullNsm->SetBinContent(494,2);
   pullNsm->SetBinContent(495,5);
   pullNsm->SetBinContent(496,5);
   pullNsm->SetBinContent(497,2);
   pullNsm->SetBinContent(498,6);
   pullNsm->SetBinContent(499,8);
   pullNsm->SetBinContent(500,38);
   pullNsm->SetBinContent(501,26);
