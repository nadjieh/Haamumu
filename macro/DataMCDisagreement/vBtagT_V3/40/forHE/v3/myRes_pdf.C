...
//========= by ROOT version5.34/19
   ...
   residualNsm->SetBinContent(994,5);
   residualNsm->SetBinContent(996,3);
   residualNsm->SetBinContent(997,5);
   residualNsm->SetBinContent(998,3);
   residualNsm->SetBinContent(999,9);
   residualNsm->SetBinContent(1000,34);
   residualNsm->SetBinContent(1001,22);
   residualNsm->SetBinContent(1002,7);
   residualNsm->SetBinContent(1003,1);
   residualNsm->SetBinContent(1004,2);
   residualNsm->SetBinContent(1006,1);
   residualNsm->SetBinContent(1009,1);
