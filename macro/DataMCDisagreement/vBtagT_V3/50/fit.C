...
fit()
{
  ...
  TFile* f = new TFile("mcMass50.root", "READ");
  ...
  /*
  TFile* f = new TFile("DoubleMu2012_Summer12_final_6.root", "READ");
 ...
 //////////// FIT IN SIGNAL REGION, SM /////////
  ...
  TFile* ftop = new TFile("TTFullLept_Summer12_final_6.root", "READ");
