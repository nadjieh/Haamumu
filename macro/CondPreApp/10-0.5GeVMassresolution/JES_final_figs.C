...
// ------------>Primitives in pad: C_1
   ...
   grae->SetPointError(0,0,0,0.003004145,0.003003688);
   grae->SetPoint(1,40,39.94931);
   grae->SetPointError(1,0,0,0.0003814175,0.0002950292);
   grae->SetPoint(2,50,49.90091);
   grae->SetPointError(2,0,0,0.006248464,0.006230438);
   grae->SetPoint(3,60,59.89713);
   grae->SetPointError(3,0,0,0.0009487452,0.001048071);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_2
   ...
   grae->SetPointError(0,0,0,0.0007880578,0.000440123);
   grae->SetPoint(1,40,0.3810689);
   grae->SetPointError(1,0,0,0.002986411,0.002850996);
   grae->SetPoint(2,50,0.487961);
   grae->SetPointError(2,0,0,0.002874717,0.003161333);
   grae->SetPoint(3,60,0.591851);
   grae->SetPointError(3,0,0,0.0002905822,7.752989e-05);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_3
   ...
   grae->SetPointError(0,0,0,0.002392026,0.001722978);
   grae->SetPoint(1,40,0.6835205);
   grae->SetPointError(1,0,0,6.660049e-05,4.673873e-05);
