...
//=========  (Tue May 19 17:14:47 2015) by ROOT version5.34/19
   TCanvas *C = new TCanvas("C", "C",3,106,1179,557);
   C->Range(0,0,1,1);
   C->SetFillColor(0);
   C->SetBorderMode(0);
   C->SetBorderSize(2);
...
// ------------>Primitives in pad: C_1
   ...
   double slope = (59.69975 - 29.51656)/(59.80987 - 29.61974);
   double intercept = (59.80987*29.51656 - 29.61974*59.69975 )/(59.80987 - 29.61974);   
   cout<<slope<<endl;
   cout<<intercept<<endl;   
