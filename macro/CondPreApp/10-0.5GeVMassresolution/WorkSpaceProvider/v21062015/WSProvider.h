...
public:
    ...
    WSProvider(MeanErr systYield, FixedParams fixed_, double UncSig) : sigNormUnc(UncSig) {
        ...
        w->import(*var);
        w->factory("MH[20,70]");
        w->factory("y0[5.80131, 0, 10.]");
        w->factory("y1[-0.138701, -1., 0.8]");
        w->factory("y2[0.00187576, 0.,5.]");
        ...
        w->factory("RooPolyVar::mean(MH,{m0,m1})");
        w->factory("RooPolyVar::sigma_cb(MH,{b0,b1})");
        w->factory("RooPolyVar::sigma(MH,{a0,a1})");
