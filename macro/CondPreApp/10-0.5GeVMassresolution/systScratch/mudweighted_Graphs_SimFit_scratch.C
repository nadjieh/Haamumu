...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,29.96);
   gre->SetPointError(0,0,0.006266913);
   gre->SetPoint(1,40,39.94885);
   gre->SetPointError(1,0,0.0084547);
   gre->SetPoint(2,50,49.90226);
   gre->SetPointError(2,0,0.009708446);
   gre->SetPoint(3,60,59.89923);
   gre->SetPointError(3,0,0.01099943);
   gre->Draw("lp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigmamud");
   gre->SetTitle("Sigmamud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.2876888);
   gre->SetPointError(0,0,0.02324035);
   gre->SetPoint(1,40,0.3582835);
   gre->SetPointError(1,0,0.05027355);
   gre->SetPoint(2,50,0.4966786);
   gre->SetPointError(2,0,0.02526158);
   gre->SetPoint(3,60,0.5859948);
   gre->SetPointError(3,0,0.0316502);
   gre->Draw("lp");
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigma_cbmud");
   gre->SetTitle("Sigma_cbmud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.4857931);
   gre->SetPointError(0,0,0.04655173);
   gre->SetPoint(1,40,0.6401307);
   gre->SetPointError(1,0,0.082198);
   gre->SetPoint(2,50,0.8749021);
   gre->SetPointError(2,0,0.0601588);
   gre->SetPoint(3,60,1.054303);
   gre->SetPointError(3,0,0.06137807);
   gre->Draw("lp");
   Graphs_3->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_4
   ...
   graph->SetPoint(0,30,0.002116400162);
   graph->SetPoint(1,40,0.08497161029);
   graph->SetPoint(2,50,0.002116400162);
   graph->SetPoint(3,60,0.08497161029);
   graph->Draw("alp");
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Widthmud");
   gre->SetTitle("Widthmud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.04546171);
   gre->SetPointError(0,0,0.01597264);
   gre->SetPoint(1,40,0.03672759);
   gre->SetPointError(1,0,0.03408209);
   gre->SetPoint(2,50,0.0478502);
   gre->SetPointError(2,0,0.02080843);
   gre->SetPoint(3,60,0.02835864);
   gre->SetPointError(3,0,0.01849302);
   gre->Draw("lp");
   Graphs_4->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_5
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,1.861957412);
   graph->SetPoint(1,40,4.85296488);
   graph->SetPoint(2,50,1.861957412);
   ...
   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,3.212659);
   gre->SetPointError(0,0,0.8852119);
   gre->SetPoint(1,40,3.054974);
   gre->SetPointError(1,0,0.6718234);
   gre->SetPoint(2,50,3.522835);
   gre->SetPointError(2,0,0.8150591);
   gre->SetPoint(3,60,3.033799);
   gre->SetPointError(3,0,0.4557174);
   gre->Draw("lp");
   Graphs_5->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_6
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.6073894953);
   graph->SetPoint(1,40,1.57076484);
   graph->SetPoint(2,50,0.6073894953);
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Alphamud");
   gre->SetTitle("Alphamud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,1.01364);
   gre->SetPointError(0,0,0.2544034);
   gre->SetPoint(1,40,1.152405);
   gre->SetPointError(1,0,0.2357166);
   gre->SetPoint(2,50,0.9607775);
   gre->SetPointError(2,0,0.1810453);
   gre->SetPoint(3,60,1.109261);
   gre->SetPointError(3,0,0.1463251);
   gre->Draw("lp");
   Graphs_6->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_7
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.3006112692);
   graph->SetPoint(1,40,0.891299448);
   graph->SetPoint(2,50,0.3006112692);
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Fracmud");
   gre->SetTitle("Fracmud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ff9933");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.6490712);
   gre->SetPointError(0,0,0.1204417);
   gre->SetPoint(1,40,0.5361484);
   gre->SetPointError(1,0,0.1603844);
   gre->SetPoint(2,50,0.6953734);
   gre->SetPointError(2,0,0.06663213);
   gre->SetPoint(3,60,0.5928539);
   gre->SetPointError(3,0,0.07260672);
   gre->Draw("lp");
   Graphs_7->Modified();
   Graphs->cd();
