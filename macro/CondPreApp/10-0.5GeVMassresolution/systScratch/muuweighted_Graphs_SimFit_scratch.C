...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,29.9575);
   gre->SetPointError(0,0,0.006230761);
   gre->SetPoint(1,40,39.94471);
   gre->SetPointError(1,0,0.00834309);
   gre->SetPoint(2,50,49.90593);
   gre->SetPointError(2,0,0.01141807);
   gre->SetPoint(3,60,59.89756);
   gre->SetPointError(3,0,0.01112393);
   gre->Draw("lp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigmamuu");
   gre->SetTitle("Sigmamuu");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.291807);
   gre->SetPointError(0,0,0.02197472);
   gre->SetPoint(1,40,0.3849759);
   gre->SetPointError(1,0,0.02751654);
   gre->SetPoint(2,50,0.4512478);
   gre->SetPointError(2,0,0.05070975);
   gre->SetPoint(3,60,0.5836509);
   gre->SetPointError(3,0,0.03774365);
   gre->Draw("lp");
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigma_cbmuu");
   gre->SetTitle("Sigma_cbmuu");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.5285087);
   gre->SetPointError(0,0,0.05807938);
   gre->SetPoint(1,40,0.7023346);
   gre->SetPointError(1,0,0.06626301);
   gre->SetPoint(2,50,0.7832737);
   gre->SetPointError(2,0,0.09803328);
   gre->SetPoint(3,60,1.047383);
   gre->SetPointError(3,0,0.07479452);
   gre->Draw("lp");
   Graphs_3->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_4
   ...
   graph->SetPoint(0,30,0.003606773154);
   graph->SetPoint(1,40,0.102416604);
   graph->SetPoint(2,50,0.003606773154);
   graph->SetPoint(3,60,0.102416604);
   graph->Draw("alp");
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Widthmuu");
   gre->SetTitle("Widthmuu");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.04141925);
   gre->SetPointError(0,0,0.01539481);
   gre->SetPoint(1,40,0.02274443);
   gre->SetPointError(1,0,0.01823596);
   gre->SetPoint(2,50,0.06925286);
   gre->SetPointError(2,0,0.03028039);
   gre->SetPoint(3,60,0.02894895);
   gre->SetPointError(3,0,0.02030855);
   gre->Draw("lp");
   Graphs_4->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_5
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,1.948456631);
   graph->SetPoint(1,40,4.85296488);
   graph->SetPoint(2,50,1.948456631);
   ...
   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,3.246592);
   gre->SetPointError(0,0,0.811021);
   gre->SetPoint(1,40,3.409968);
   gre->SetPointError(1,0,0.7048982);
   gre->SetPoint(2,50,3.107671);
   gre->SetPointError(2,0,0.3960912);
   gre->SetPoint(3,60,2.9228);
   gre->SetPointError(3,0,0.4367502);
   gre->Draw("lp");
   Graphs_5->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_6
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Alphamuu");
   gre->SetTitle("Alphamuu");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,1.030852);
   gre->SetPointError(0,0,0.2176879);
   gre->SetPoint(1,40,1.047169);
   gre->SetPointError(1,0,0.1719536);
   gre->SetPoint(2,50,1.1677);
   gre->SetPointError(2,0,0.2853504);
   gre->SetPoint(3,60,1.15531);
   gre->SetPointError(3,0,0.1564136);
   gre->Draw("lp");
   Graphs_6->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_7
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.3199207215);
   graph->SetPoint(1,40,0.891299448);
   graph->SetPoint(2,50,0.3199207215);
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Fracmuu");
   gre->SetTitle("Fracmuu");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#ffcc66");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.6504313);
   gre->SetPointError(0,0,0.1093998);
   gre->SetPoint(1,40,0.6130904);
   gre->SetPointError(1,0,0.09361677);
   gre->SetPoint(2,50,0.5257974);
   gre->SetPointError(2,0,0.1258965);
   gre->SetPoint(3,60,0.561153);
   gre->SetPointError(3,0,0.09051994);
   gre->Draw("lp");
   Graphs_7->Modified();
   Graphs->cd();
