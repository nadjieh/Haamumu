...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetName("MeanJESD");
   gre->SetTitle("MeanJESD");
   gre->SetFillColor(1);
   ...
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,29.96111);
   gre->SetPointError(0,0,0.00637108);
   gre->SetPoint(1,40,39.94684);
   gre->SetPointError(1,0,0.008418422);
   gre->SetPoint(2,50,49.90724);
   gre->SetPointError(2,0,0.01005931);
   gre->SetPoint(3,60,59.89386);
   gre->SetPointError(3,0,0.01120447);
   gre->Draw("lp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre = new TGraphErrors(4);
   gre->SetName("SigmaJESD");
   gre->SetTitle("SigmaJESD");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.2871951);
   gre->SetPointError(0,0,0.01859529);
   gre->SetPoint(1,40,0.3871806);
   gre->SetPointError(1,0,0.02299523);
   gre->SetPoint(2,50,0.4953689);
   gre->SetPointError(2,0,0.02799294);
   gre->SetPoint(3,60,0.5690149);
   gre->SetPointError(3,0,0.03572133);
   gre->Draw("lp");
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigma_cbJESD");
   gre->SetTitle("Sigma_cbJESD");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.5018774);
   gre->SetPointError(0,0,0.03788638);
   gre->SetPoint(1,40,0.7108626);
   gre->SetPointError(1,0,0.05167814);
   gre->SetPoint(2,50,0.8615808);
   gre->SetPointError(2,0,0.06964912);
   gre->SetPoint(3,60,1.037354);
   gre->SetPointError(3,0,0.05994467);
   gre->Draw("lp");
   Graphs_3->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_4
   ...
   graph->SetPoint(0,30,0.004622009285);
   graph->SetPoint(1,40,0.08255127683);
   graph->SetPoint(2,50,0.004622009285);
   graph->SetPoint(3,60,0.08255127683);
   graph->Draw("alp");
   ...
   gre = new TGraphErrors(4);
   gre->SetName("WidthJESD");
   gre->SetTitle("WidthJESD");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.04731477);
   gre->SetPointError(0,0,0.01535728);
   gre->SetPoint(1,40,0.02112579);
   gre->SetPointError(1,0,0.01534828);
   gre->SetPoint(2,50,0.0458949);
   gre->SetPointError(2,0,0.02289783);
   gre->SetPoint(3,60,0.03285376);
   gre->SetPointError(3,0,0.02109022);
   gre->Draw("lp");
   Graphs_4->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_5
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,1.932825855);
   graph->SetPoint(1,40,4.85296488);
   graph->SetPoint(2,50,1.932825855);
   ...
   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,3.503018);
   gre->SetPointError(0,0,0.9306941);
   gre->SetPoint(1,40,3.533823);
   gre->SetPointError(1,0,0.7051897);
   gre->SetPoint(2,50,3.607954);
   gre->SetPointError(2,0,0.834584);
   gre->SetPoint(3,60,2.767948);
   gre->SetPointError(3,0,0.3519159);
   gre->Draw("lp");
   Graphs_5->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_6
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.6358754106);
   graph->SetPoint(1,40,1.57076484);
   graph->SetPoint(2,50,0.6358754106);
   ...
   gre = new TGraphErrors(4);
   gre->SetName("AlphaJESD");
   gre->SetTitle("AlphaJESD");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.9965304);
   gre->SetPointError(0,0,0.2016862);
   gre->SetPoint(1,40,1.0444);
   gre->SetPointError(1,0,0.1547848);
   gre->SetPoint(2,50,0.9779457);
   gre->SetPointError(2,0,0.1818232);
   gre->SetPoint(3,60,1.212654);
   gre->SetPointError(3,0,0.1368764);
   gre->Draw("lp");
   Graphs_6->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_7
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.3809829727);
   graph->SetPoint(1,40,0.891299448);
   graph->SetPoint(2,50,0.3809829727);
   ...
   gre = new TGraphErrors(4);
   gre->SetName("FracJESD");
   gre->SetTitle("FracJESD");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#009999");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.6513346);
   gre->SetPointError(0,0,0.08825695);
   gre->SetPoint(1,40,0.627607);
   gre->SetPointError(1,0,0.07472504);
   gre->SetPoint(2,50,0.6749332);
   gre->SetPointError(2,0,0.07702569);
   gre->SetPoint(3,60,0.5532748);
   gre->SetPointError(3,0,0.0770461);
   gre->Draw("lp");
   Graphs_7->Modified();
   Graphs->cd();
