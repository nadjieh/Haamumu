...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,29.95875);
   gre->SetPointError(0,0,0.00654346);
   gre->SetPoint(1,40,39.94769);
   gre->SetPointError(1,0,0.00857455);
   gre->SetPoint(2,50,49.90473);
   gre->SetPointError(2,0,0.0107292);
   gre->SetPoint(3,60,59.89663);
   gre->SetPointError(3,0,0.01140288);
   gre->Draw("lp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigmapud");
   gre->SetTitle("Sigmapud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.2887836);
   gre->SetPointError(0,0,0.01670268);
   gre->SetPoint(1,40,0.3831928);
   gre->SetPointError(1,0,0.01809022);
   gre->SetPoint(2,50,0.4976716);
   gre->SetPointError(2,0,0.02080364);
   gre->SetPoint(3,60,0.5872755);
   gre->SetPointError(3,0,0.02500657);
   gre->Draw("lp");
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Sigma_cbpud");
   gre->SetTitle("Sigma_cbpud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.4794547);
   gre->SetPointError(0,0,0.03536876);
   gre->SetPoint(1,40,0.693876);
   gre->SetPointError(1,0,0.04396512);
   gre->SetPoint(2,50,0.906806);
   gre->SetPointError(2,0,0.05337255);
   gre->SetPoint(3,60,1.049111);
   gre->SetPointError(3,0,0.04765082);
   gre->Draw("lp");
   Graphs_3->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_4
   ...
   graph->SetPoint(1,40,0.07866954952);
   graph->SetPoint(2,50,0.004655784);
   graph->SetPoint(3,60,0.07866954952);
   graph->Draw("alp");
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Widthpud");
   gre->SetTitle("Widthpud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.05018351);
   gre->SetPointError(0,0,0.01537444);
   gre->SetPoint(1,40,0.02399114);
   gre->SetPointError(1,0,0.01690336);
   gre->SetPoint(2,50,0.02737924);
   gre->SetPointError(2,0,0.0170023);
   gre->SetPoint(3,60,0.03153785);
   gre->SetPointError(3,0,0.01937874);
   gre->Draw("lp");
   Graphs_4->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_5
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,1.883610859);
   graph->SetPoint(1,40,4.85296488);
   graph->SetPoint(2,50,1.883610859);
   ...
   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,2.819208);
   gre->SetPointError(0,0,0.4646946);
   gre->SetPoint(1,40,3.384942);
   gre->SetPointError(1,0,0.579423);
   gre->SetPoint(2,50,3.602739);
   gre->SetPointError(2,0,0.6756714);
   gre->SetPoint(3,60,2.804039);
   gre->SetPointError(3,0,0.3071176);
   gre->Draw("lp");
   Graphs_5->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_6
   ...
   graph->SetLineColor(0);
   graph->SetMarkerColor(0);
   graph->SetPoint(0,30,0.6446721114);
   graph->SetPoint(1,40,1.519155555);
   graph->SetPoint(2,50,0.6446721114);
   graph->SetPoint(3,60,1.519155555);
   graph->Draw("alp");
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Alphapud");
   gre->SetTitle("Alphapud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,1.098711);
   gre->SetPointError(0,0,0.1672524);
   gre->SetPoint(1,40,1.0425);
   gre->SetPointError(1,0,0.1281262);
   gre->SetPoint(2,50,0.9383852);
   gre->SetPointError(2,0,0.132545);
   gre->SetPoint(3,60,1.151921);
   gre->SetPointError(3,0,0.1093873);
   gre->Draw("lp");
   Graphs_6->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_7
   ...
   gre = new TGraphErrors(4);
   gre->SetName("Fracpud");
   gre->SetTitle("Fracpud");
   gre->SetFillColor(1);

   ci = TColor::GetColor("#000099");
   gre->SetLineColor(ci);
   gre->SetPoint(0,30,0.6386182);
   gre->SetPointError(0,0,0.08359503);
   gre->SetPoint(1,40,0.6287102);
   gre->SetPointError(1,0,0.05665184);
   gre->SetPoint(2,50,0.696238);
   gre->SetPointError(2,0,0.04989094);
   gre->SetPoint(3,60,0.6032146);
   gre->SetPointError(3,0,0.05283322);
   gre->Draw("lp");
   Graphs_7->Modified();
   Graphs->cd();
