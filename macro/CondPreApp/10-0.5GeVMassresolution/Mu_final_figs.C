...
// ------------>Primitives in pad: C_1
   ...
   grae->SetPointError(1,0,0,1.350031e-12,0.0001234047);
   grae->SetPoint(2,50,49.90091);
   grae->SetPointError(2,0,0,5.329071e-13,1.100834e-05);
   grae->SetPoint(3,60,59.89713);
   grae->SetPointError(3,0,0,1.548983e-12,0.0001844169);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_2
   ...
   grae->SetPointError(2,0,0,5.637713e-13,0.0001366529);
   grae->SetPoint(3,60,0.591851);
   grae->SetPointError(3,0,0,3.012035e-13,0.0002548107);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_3
   ...
   grae->SetPointError(1,0,0,3.925749e-12,9.314515e-05);
   grae->SetPoint(2,50,0.841637);
   grae->SetPointError(2,0,0,5.77316e-13,2.511147e-06);
   grae->SetPoint(3,60,1.071645);
   grae->SetPointError(3,0,0,1.313394e-12,0.0001468295);
   grae->Draw("alp");
