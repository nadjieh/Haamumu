...
// ------------>Primitives in pad: C_1
   ...
   grae->SetPointError(1,0,0,1.350031e-12,1.33582e-12);
   grae->SetPoint(2,50,49.90091);
   grae->SetPointError(2,0,0,1.253383e-05,5.329071e-13);
   grae->SetPoint(3,60,59.89713);
   grae->SetPointError(3,0,0,1.548983e-12,8.461093e-05);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_2
   ...
   grae->SetPointError(1,0,0,2.256917e-12,1.751321e-12);
   grae->SetPoint(2,50,0.487961);
   grae->SetPointError(2,0,0,0.0007657354,5.637713e-13);
   grae->SetPoint(3,60,0.591851);
   grae->SetPointError(3,0,0,3.012035e-13,7.981832e-05);
   grae->Draw("alp");
...
// ------------>Primitives in pad: C_3
   ...
   grae->SetPointError(1,0,0,3.925749e-12,4.055645e-12);
   grae->SetPoint(2,50,0.841637);
   grae->SetPointError(2,0,0,0.002805451,5.77316e-13);
   grae->SetPoint(3,60,1.071645);
   grae->SetPointError(3,0,0,1.313394e-12,7.752793e-05);
   grae->Draw("alp");
