...
//=========  (Wed May 20 18:25:59 2015) by ROOT version5.34/19
...
// ------------>Primitives in pad: Graphs_1
   TPad *Graphs_1 = new TPad("Graphs_1", "Graphs_1",0.01,0.51,0.3233333,0.99);
   Graphs_1->Draw();
   Graphs_1->cd();
...
// ------------>Primitives in pad: Graphs_2
   Graphs_2 = new TPad("Graphs_2", "Graphs_2",0.3433333,0.51,0.6566667,0.99);
   Graphs_2->Draw();
   Graphs_2->cd();
...
// ------------>Primitives in pad: Graphs_3
   Graphs_3 = new TPad("Graphs_3", "Graphs_3",0.6766667,0.51,0.99,0.99);
   Graphs_3->Draw();
   Graphs_3->cd();
...
// ------------>Primitives in pad: Graphs_4
   Graphs_4 = new TPad("Graphs_4", "Graphs_4",0.01,0.01,0.3233333,0.49);
   Graphs_4->Draw();
   Graphs_4->cd();
...
// ------------>Primitives in pad: Graphs_5
   Graphs_5 = new TPad("Graphs_5", "Graphs_5",0.3433333,0.01,0.6566667,0.49);
   Graphs_5->Draw();
   Graphs_5->cd();
...
// ------------>Primitives in pad: Graphs_6
   Graphs_6 = new TPad("Graphs_6", "Graphs_6",0.6766667,0.01,0.99,0.49);
   Graphs_6->Draw();
   Graphs_6->cd();
