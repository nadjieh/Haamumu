...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetTitle("Mean");
   gre->SetFillColor(1);
   gre->SetPoint(0,30,29.96017);
   gre->SetPointError(0,0,0.005771518);
   gre->SetPoint(1,40,39.94905);
   gre->SetPointError(1,0,0.007566912);
   gre->SetPoint(2,50,49.89925);
   gre->SetPointError(2,0,0.009158117);
   gre->SetPoint(3,60,59.89846);
   gre->SetPointError(3,0,0.01023387);
   gre->Draw("alp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre->SetTitle("Sigma");
   gre->SetFillColor(1);
   gre->SetPoint(0,30,0.2826573);
   gre->SetPointError(0,0,0.009823685);
   gre->SetPoint(1,40,0.3832295);
   gre->SetPointError(1,0,0.01268178);
   gre->SetPoint(2,50,0.4820051);
   gre->SetPointError(2,0,0.0168429);
   gre->SetPoint(3,60,0.5929326);
   gre->SetPointError(3,0,0.01773568);
   gre->Draw("alp");
      TF1 * puu = new TF1("puu","pol1",25.,65.);
   gre->Fit(puu);
   cout<<"|Up|"<<puu->GetParameter(0)<<"|"<<puu->GetParameter(1)<<endl;   
   cout<<"\t\tSigmapuu = new TF1(\"Sigmapuu\",\""<<puu->GetParameter(0)<<"+("<<puu->GetParameter(1)<<"*x)\",20.,70.);            "       <<        endl;  
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre->SetFillColor(1);
   gre->SetPoint(0,30,0.4975692);
   gre->SetPointError(0,0,0.02363644);
   gre->SetPoint(1,40,0.7004616);
   gre->SetPointError(1,0,0.03108131);
   gre->SetPoint(2,50,0.83644);
   gre->SetPointError(2,0,0.03927801);
   gre->SetPoint(3,60,1.062367);
   gre->SetPointError(3,0,0.03963546);
   gre->Draw("alp");
