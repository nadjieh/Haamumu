...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetPointError(0,0,0.005778215);
   gre->SetPoint(1,40,39.94906);
   gre->SetPointError(1,0,0.007568711);
   gre->SetPoint(2,50,49.89927);
   gre->SetPointError(2,0,0.00916232);
   gre->SetPoint(3,60,59.89839);
   gre->SetPointError(3,0,0.01023597);
   gre->Draw("alp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre->SetPointError(0,0,0.01050703);
   gre->SetPoint(1,40,0.383193);
   gre->SetPointError(1,0,0.01306748);
   gre->SetPoint(2,50,0.4820418);
   gre->SetPointError(2,0,0.01733215);
   gre->SetPoint(3,60,0.5930222);
   gre->SetPointError(3,0,0.01828533);
   gre->Draw("alp");
      TF1 * mud = new TF1("mud","pol1",25.,65.);
   gre->Fit(mud);
   cout<<"|Down|"<<mud->GetParameter(0)<<"|"<<mud->GetParameter(1)<<endl;   
   cout<<"\t\tSigmamud = new TF1(\"Sigmamud\",\""<<mud->GetParameter(0)<<"+("<<mud->GetParameter(1)<<"*x)\",20.,70.);            "       <<        endl;
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre->SetPointError(0,0,0.02410775);
   gre->SetPoint(1,40,0.7001759);
   gre->SetPointError(1,0,0.03174386);
   gre->SetPoint(2,50,0.8360851);
   gre->SetPointError(2,0,0.03984088);
   gre->SetPoint(3,60,1.062316);
   gre->SetPointError(3,0,0.04043953);
   gre->Draw("alp");
