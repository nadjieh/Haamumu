...
// ------------>Primitives in pad: Graphs_1
   ...
   gre->SetTitle("Mean");
   gre->SetFillColor(1);
   gre->SetPoint(0,30,29.96019);
   gre->SetPointError(0,0,0.005772667);
   gre->SetPoint(1,40,39.94913);
   gre->SetPointError(1,0,0.00756688);
   gre->SetPoint(2,50,49.89986);
   gre->SetPointError(2,0,0.009640029);
   gre->SetPoint(3,60,59.89859);
   gre->SetPointError(3,0,0.01023767);
   gre->Draw("alp");
   Graphs_1->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_2
   ...
   gre->SetTitle("Sigma");
   gre->SetFillColor(1);
   gre->SetPoint(0,30,0.2825495);
   gre->SetPointError(0,0,0.009805372);
   gre->SetPoint(1,40,0.3829054);
   gre->SetPointError(1,0,0.01263393);
   gre->SetPoint(2,50,0.4848175);
   gre->SetPointError(2,0,0.01678557);
   gre->SetPoint(3,60,0.5931196);
   gre->SetPointError(3,0,0.01764451);
   gre->Draw("alp");
      TF1 * fbd = new TF1("fbd","pol1",25.,65.);
   gre->Fit(fbd);
   cout<<"|Down|"<<fbd->GetParameter(0)<<"|"<<fbd->GetParameter(1)<<endl;
   cout<<"\t\tSigmabd = new TF1(\"Sigmabd\",\""<<fbd->GetParameter(0)<<"+("<<fbd->GetParameter(1)<<"*x)\",20.,70.);"       <<        endl;
   Graphs_2->Modified();
   Graphs->cd();
...
// ------------>Primitives in pad: Graphs_3
   ...
   gre->SetFillColor(1);
   gre->SetPoint(0,30,0.4973906);
   gre->SetPointError(0,0,0.02355772);
   gre->SetPoint(1,40,0.7004029);
   gre->SetPointError(1,0,0.03097024);
   gre->SetPoint(2,50,0.8409045);
   gre->SetPointError(2,0,0.03704901);
   gre->SetPoint(3,60,1.061915);
   gre->SetPointError(3,0,0.03936065);
   gre->Draw("alp");
   Graphs_3->Modified();
   Graphs->cd();
   Graphs->Modified();
