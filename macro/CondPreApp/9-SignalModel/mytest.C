...
RooFitResult* fitToSignal(TString Mass, int nbin = 50){
    	...
    	//TFile * fsig = new TFile("JERD_H2ToH1H1_H1To2Mu2B_mH2-125_mH1_" + Mass + "_Summer12_final_" + pf + ".root", "read");
    	//TFile * fsig = new TFile("JERU_H2ToH1H1_H1To2Mu2B_mH2-125_mH1_" + Mass + "_Summer12_final_" + pf + ".root", "read");    	
    	...
    	RooRealVar sigma("sigma", "sigma", 0.2,0,5.);  
