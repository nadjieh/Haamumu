...
void doJob(){
	...
	//myRead("aptMu","aptMu.C");
	//myRead("MET_hamb","met.C");
	//myRead("METsignificance_hamb","METSig.C");
	//myRead("amassMu","dimuTop.C");
	//myRead("amassBjet","amassBjet.C");
	//myRead("aptBjet","aptBjet.C");
	//myRead("amassMu","tt_amassMu.C");
	//myRead("hMass","tt_hMass.C");
	//	myRead("diffMassaa","diffMassaa.C");
	/*myRead("hPt","hPt.C");
	myRead("jet1pt","jet1pt.C");
	myRead("jet2pt","jet2pt.C");
	myRead("mu1pt","mu1pt.C");
	myRead("mu2pt","mu2pt.C");*/
//	myRead("amassMu","mass.C");
	myRead("amassMu","mass20.C");
	myRead("amassMu","mass30.C");
	myRead("amassMu","mass402.C");
	myRead("amassMu","mass502.C");
	myRead("amassMu","mass602.C");			
	//myRead("amassMu","amassMu_9.C");	
}
