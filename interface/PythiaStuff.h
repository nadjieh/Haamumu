...
// Tue Jul 15 13:22:10 2014 by ROOT version 5.32/00
// from TTree LHEF/Analysis tree
// found on file: tag_1_pythia_lhe_events.root
//////////////////////////////////////////////////////////

#ifndef PythiaStuff_h
#define PythiaStuff_h
...
public :
   ...
   PythiaStuff(TTree *tree = 0, TFile * f = 0, TString treeName = "LHEF") {
